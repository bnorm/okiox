...
interface BufferedAsyncSource : AsyncSource {
   ...
   * ```
   *
   * **On the end of the stream this method returns null,** just like BufferedReader. If
  ...
  /**
   * Returns a new `BufferedAsyncSource` that can read data from this `BufferedAsyncSource` without consuming
